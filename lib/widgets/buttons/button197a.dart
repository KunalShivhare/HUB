...
class Button197a extends StatelessWidget {
  ...
  final bool upIcon;
  Button197a({this.pressButtonDelete, this.pressSetCurrent,
  ...
  Widget build(BuildContext context) {
    return Container(
        decoration: BoxDecoration(
          color: (onlyBorder) ? Colors.transparent : darkMode ? Colors.black : Colors.white,
          border: (onlyBorder) ? Border.all(color: darkMode ? Colors.black : Colors.white) : null,
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: <Widget>[
                    SizedBox(width: 15,),
                    Icon(item.type == 1 ? Icons.home : item.type == 2 ? Icons.account_balance : Icons.devices_other, color: mainColor,),
                    SizedBox(width: 15,),
