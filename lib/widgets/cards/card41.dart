...
class Card41 extends StatelessWidget {
  ...
  const Card41({Key? key, required this.image, required this.text1, required this.style1, required this.text2, required this.style2,
    required this.text3, required this.style3, this.shadow = false, this.bkgColor = Colors.white, this.radius = 10, this.imageRadius = 50,
              ...
              Expanded(
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Expanded(child: Text(text1, style: style1, maxLines: 1, overflow: TextOverflow.ellipsis,)),
                          SizedBox(width: 10,),
                          if (unread != 0)
                            Container(
