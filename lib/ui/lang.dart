              ...
              children: [
                ...
                Container(
                  ...
                  child: button2s(strings.get(2), // "SUBMIT",
                      theme.style16W800White, mainColor, 50, (){_submit();}, true),
                )
              ]),
        ));
  }
  ...
  _radioGroup(){
    ...
    for (var item in _mainModel.appLangs)
      list.add(ListTile(
          ...
          leading: Radio(
            value: item.locale,
            groupValue: _mainModel.localAppSettings.currentServiceAppLanguage,
            activeColor: mainColor,
            onChanged: (String? value) {
              if (value == null)
                return;
              _set = true;
              _mainModel.setLang(value, context);
              setState(() {
              });
            },
          )));
