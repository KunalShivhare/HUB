...
class OnDemandServiceTheme{
  ...
  factory OnDemandServiceTheme.fromJson(Map<String, dynamic> data){
  ...
  TextStyle style10W600Grey = TextStyle(fontFamily: _font, letterSpacing: 0.6,
      fontSize: 10, fontWeight: FontWeight.w600, color:darkMode?Colors.white: Colors.grey);
  ...
  TextStyle style11W600 = TextStyle(fontFamily: _font, letterSpacing: 0.4,
  ...
  TextStyle style12W800W = TextStyle(fontFamily: _font, letterSpacing: 0.4,
      fontSize: 15, fontWeight: FontWeight.w900, color: darkMode? Colors.white:Colors.black);
  ...
  TextStyle style12W800 = TextStyle(fontFamily: _font, letterSpacing: 0.6,
      fontSize: 14, fontWeight: FontWeight.w900, color: (darkMode) ? Colors.white : Colors.black);

  TextStyle style13W800 = TextStyle(fontFamily: _font, letterSpacing: 0.6,
  ...
  TextStyle style13W400 = TextStyle(fontFamily: _font, letterSpacing: 0.6,
  ...
  TextStyle style16W400 = TextStyle(fontFamily: _font, letterSpacing: 0.6,
      fontSize: 16, fontWeight: FontWeight.w400, color: (darkMode) ? Colors.white : Colors.black);
  ...
  TextStyle style16W800Main = TextStyle(fontFamily: _font, letterSpacing: 0.6,
     fontSize: 16, fontWeight: FontWeight.w800, color: mainColor);
  ...
  TextStyle style25W400 = TextStyle(fontFamily: _font, letterSpacing: 0.4,
