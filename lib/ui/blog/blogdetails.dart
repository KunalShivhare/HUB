...
class _BlogDetailsScreenState extends State<BlogDetailsScreen> {
  ...
  _body(){
    return Container(
      ...
      children: [
        Text(getTextByLocale(_mainModel.openBlog!.name), style: theme.style14W800,),
        SizedBox(height: 10),
        Text(timeago.format(_mainModel.openBlog!.time, locale: _mainModel.localAppSettings.currentServiceAppLanguage),
            overflow: TextOverflow.ellipsis, style: theme.style10W600Grey),
        SizedBox(height: 20,),
        Html(
            data: "<body>${getTextByLocale(_mainModel.openBlog!.text)}",
            style: {
              "body": Style(
                  backgroundColor: (darkMode) ? Colors.black : Colors.white,
