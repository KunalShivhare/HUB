...
class _MapDetailsScreenState extends State<MapDetailsScreen> {
    ...
    return Scaffold(
        ...
        child: Stack(
          children: <Widget>[
            ...
            appbar1t(Colors.transparent,
                (darkMode) ? Colors.white : Colors.black, strings.get(216), /// "Location"
                theme.style14W800, context, () {_mainModel.goBack();})
          ],
        )
    ));
  }
  ...
  _delete() async {
    var ret = await _mainModel.userAccount.deleteLocation(_mainModel.addressData!);
    if (ret != null)
